...
- Added Gaming Mode UI, Russian and English localization, credentials UI, diagnostics, report export, migration, tests, CI, reproducible native builds, and verified release packaging.
